...
class Business(models.Model):
    ...
    # Rating computed fields (updated on each review save via signal)
...
class BusinessProduct(models.Model):
    ...
    price_unit = models.CharField(max_length=50, blank=True, help_text="e.g. per bird, per kg, per tray")
